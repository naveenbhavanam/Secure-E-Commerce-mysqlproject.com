...
<body class="bg-gradient-to-r from-indigo-500 to-purple-600 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-lg rounded-xl p-8 max-w-sm w-full space-y-6">
        ...
        <div class="space-y-4">
            ...
            <input type="email" id="requestEmail" name="request_email" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400" value="{{ $email }}" placeholder="Your email address">
