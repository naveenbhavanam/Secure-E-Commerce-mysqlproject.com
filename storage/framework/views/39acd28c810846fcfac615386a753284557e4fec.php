...
<body class="bg-gray-100 font-sans">
    ...
    <nav class="bg-gray-800 text-white p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="space-x-6">
                <a href="<?php echo e(route('welcome')); ?>" class="hover:text-gray-400">Home</a>
                <a href="<?php echo e(route('profile.show')); ?>" class="hover:text-gray-400">Profile</a>
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <div class="bg-white p-6 mt-6 rounded-lg shadow-md">
            ...
            <div class="flex flex-col items-center mb-6 space-y-4">
                <img src="<?php echo e(Auth::user()->profile_photo_url); ?>" alt="Profile Picture" class="w-32 h-32 rounded-full border-4 border-gray-300">
                <p class="text-lg font-semibold">Name: <?php echo e(Auth::user()->name); ?></p>
                <p class="text-lg font-semibold">Email: <?php echo e(Auth::user()->email); ?></p>
                <p class="text-lg font-semibold">Joined: <?php echo e(Auth::user()->created_at->format('d M, Y')); ?></p>
                <p class="text-lg font-semibold">Plan: <?php echo e($mesho); ?></p>
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(Auth::user()->name); ?>" required class="w-full px-4 py-2 mt-2 border rounded-md focus:ring-2 focus:ring-blue-500">
                </div>

                <div>
                    <label for="email" class="block text-gray-700 font-semibold">Email</label>
                    <input type="email" id="email" name="email" value="<?php echo e(Auth::user()->email); ?>" required class="w-full px-4 py-2 mt-2 border rounded-md focus:ring-2 focus:ring-blue-500">
                </div>
...
<?php /**PATH /home/tonny/Laravel/prog/assignment4/projectsql/resources/views/profile/show.blade.php ENDPATH**/ ?>